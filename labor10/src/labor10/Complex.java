...
public class Complex {
    ...
    public Complex mult(Complex c) {
    	Complex ret = new Complex(this.re * c.re - this.im * c.im, this.re * c.im + this.im * c.re);
    	return ret;
    }
    
    public Complex div(Complex c) throws DivisionByZero {
		double nevezo = c.re * c.re + c.im * c.im;
		if(nevezo == 0) {
			throw new DivisionByZero();
		}
		double re = (this.re * c.re + this.im * c.im) / nevezo;
		double im = (this.im * c.re - this.re * c.im) / nevezo;
